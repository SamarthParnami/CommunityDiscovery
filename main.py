...
nodeV,comBench1,specs1 = graphGenerator.nodeChange(infoArray)
print("node done")
tau1V,comBench2,specs2 = graphGenerator.tau1Change(infoArray)
print("tau1 done")
tau2V,comBench3,specs3 = graphGenerator.tau2Change(infoArray)
print("tau2 done")
muV,comBench4,specs4   = graphGenerator.muChange(infoArray)
print("mu done")
